...
- Asked to install a skill or MCP server from a link/package: run `"$LZ_BIN" skill install <src>` or `"$LZ_BIN" mcp install <src>` (src = owner/repo, GitHub URL, npm:<pkg>, pypi:<pkg>).
